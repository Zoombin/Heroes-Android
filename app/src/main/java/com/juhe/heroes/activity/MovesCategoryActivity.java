 ...
 * 
 */
public class MovesCategoryActivity extends Activity {
	...
	private MovesCategoryAdapter adatper;
	...
	void initView() {
		...
		lv_image.setAdapter(adatper = new MovesCategoryAdapter(this));
	}
	...
	void initData() {
		...
		String imgs = ReadAssets.readAssetsData(MovesCategoryActivity.this, FileType.MOVES_cate + ".txt");
